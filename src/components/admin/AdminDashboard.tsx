  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h2 className="text-3xl font-bold text-slate-50">Admin Dashboard</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div className="bg-amber-950/20 rounded-xl p-6 shadow-sm border border-amber-900/30">
          <div className="flex items-center gap-3 mb-2">
        ...
        <div className="bg-green-950/20 rounded-xl p-6 shadow-sm border border-green-900/30">
          <div className="flex items-center gap-3 mb-2">
        ...
        <div className="bg-red-950/20 rounded-xl p-6 shadow-sm border border-red-900/30">
          <div className="flex items-center gap-3 mb-2">
        ...
        <div className="flex flex-col sm:flex-row gap-4 mb-6">
          <div className="flex-1 relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 bg-slate-800 border border-slate-700 text-slate-200 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent outline-none placeholder-slate-500"
            />
          </div>
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-slate-700">
                ...
                <th className="text-left py-3 px-4 text-sm font-semibold text-slate-300">User ID</th>
                ...
                <th className="text-left py-3 px-4 text-sm font-semibold text-slate-300">Signed Up</th>
              ...
              {filteredUsers.length === 0 ? (
                ...
                filteredUsers.map((user) => (
                  <tr key={user.id} className="border-b border-slate-800 hover:bg-slate-800/50">
                    ...
                    <td className="py-3 px-4">
                      <div className="text-sm text-slate-500 font-mono">{user.user_id.slice(0, 8)}...</div>
                    </td>
                    <td className="py-3 px-4">
                      <span
