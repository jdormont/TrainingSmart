...
* **Data Source Details**:
  * **Metric Used**: Duration (`moving_time`), not TSS or Heart Rate. This is a **Volume-based** metric.
  * **Acute Load (Fatigue)**: Total minutes of training in the last **7 days**.
  * **Chronic Load (Fitness)**: Average weekly minutes over the last **42 days** (6 weeks).
  * **Ratio**: `Acute / Chronic`.
    * Example: If you usually ride 300 mins/week (Chronic) but did 450 mins this week (Acute), your ACWR is `1.5`.
